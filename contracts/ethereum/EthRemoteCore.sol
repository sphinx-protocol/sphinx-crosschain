...
contract EthRemoteCore{
  ...
  function remoteDepositAccount(address tokenAddress, uint256 amount) external payable {
    ...
    starknetCore.sendMessageToL2{value: msg.value}(l2StorageProverAddress, SUBMIT_L1_BLOCKHASH_SELECTOR, payload);
  }
